...
-   [CppCoreGuidelines](https://github.com/isocpp/CppCoreGuidelines)
    - Guided Support Library (GSL) implementation of CppCoreGuidelines (microsoft/gcl is one implementation)
-   C++23 ISO specification
- [hsutter/cppfront](https://github.com/hsutter/cppfront)
- Profiles (main direction C++ is heading in the future)
...
- Programming: Principles and Practice Using C++ 3rd Edition by _Bjarne Stroustrup_ (2024) (656 pages)
